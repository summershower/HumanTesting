    ...
    '55Ip': function (e, t, n) {
      ...
      var v = f(function (e, t) {
        var n = e.innerRef,
          r = e.navigate,
          c = e.onClick,
          i = Object(a['a'])(e, ['innerRef', 'navigate', 'onClick']),
          o = i.target,
          s = Object(C['a'])({}, i, {
            onClick: function (e) {
              try {
      ...
      var x = f(function (e, t) {
          var n = e.component,
            ...
            o = e.to,
            j = e.innerRef,
            x = Object(a['a'])(e, ['component', 'replace', 'to', 'innerRef']);
          return l.a.createElement(r['e'].Consumer, null, function (e) {
            e || Object(s['a'])(!1);
            var n = e.history,
              r = d(u(o, e.location), e.location),
              a = r ? n.createHref(r) : '',
              v = Object(C['a'])({}, x, {
                href: a,
                navigate: function () {
                  var t = u(o, e.location),
      ...
      b(function (e, t) {
        ...
        return l.a.createElement(r['e'].Consumer, null, function (e) {
          ...
          return (
            w !== b ? (_.ref = t || L) : (_.innerRef = L),
            l.a.createElement(x, _)
          );
        });
      });
    },
    ...
    QeBL: function (e, t, n) {
      ...
      function u() {
        return Object(o['jsx'])('div', {
          ...
          children: Object(o['jsx'])('p', { children: 'github: summershower' }),
        });
      }
      function d(e) {
